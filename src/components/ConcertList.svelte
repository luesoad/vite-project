...
<ul class="concert-list flex flex-wrap justify-center gap-4 p-0 m-0">
  {#each concerts as concert}
    <li class="concert-card w-full max-w-xs sm:max-w-sm md:max-w-md bg-white dark:bg-gray-900 rounded-lg shadow p-4 flex flex-col items-center">
